...
public class ValidateUtils {
    ...
    /** 用户名规则（6-16位字母、数字） */
    public static final String USERNAME_PATTERN="^[0-9A-Za-z]{6,16}$";
    /** 固号（座机）规则 */
    ...
    * @return boolean
    ...
    /**
     * @Description: 验证用户名格式  6-16 位字母、数字
     * @param username 
     * @return boolean
      */
     public static boolean validateUsername(String username) {
         ...
         return Pattern.matches(PASSWORD_PATTERN, username);
     }
     
     /**
      * @Description: 验证字符格式  min-max 
      * @param text min max 
      * @return boolean
       */
      public static boolean validateText(String text, int min, int max) {
